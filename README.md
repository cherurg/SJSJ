...
* [UMD](/glossary/UMD.md): паттерн универсального объявления модулей для JavaScript.
...
* [WebGL](/glossary/WEBGL.md) (Web Graphics Library): JavaScript API для отрисовки интерактивной 3D и 2D графики, работающий в современных браузерах.
